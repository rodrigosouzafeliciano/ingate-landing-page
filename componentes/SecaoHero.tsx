  ...
  return (
    <section className="bg-ingate-dark relative overflow-hidden px-4 pt-16 pb-24 sm:px-10 lg:pt-24 lg:pb-32">
      <div className="absolute inset-0 z-0 pointer-events-none opacity-20">
        <svg className="w-full h-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1440 600" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex flex-col gap-16 lg:gap-24">
          <div className="max-w-4xl text-center lg:text-left mx-auto lg:mx-0">
            ...
            <p className="text-ingate-light text-lg font-normal leading-relaxed max-w-2xl mb-10 mx-auto lg:mx-0">
              Centralize solicitações, visualize percursos no mapa e converse em tempo real. A InGate é a plataforma definitiva para a gestão e intermediação tecnológica de resgates veiculares.
            </p>
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              <button className="flex cursor-pointer items-center justify-center rounded-lg bg-primary px-8 py-4 text-base font-bold text-white transition-all hover:bg-primary/90 hover:shadow-lg hover:-translate-y-0.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
              ...
              <div className="relative flex flex-col items-center group">
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl w-full hover:bg-white/10 transition-all hover:shadow-lg text-center">
                  ...
                  <div className="flex items-baseline justify-center gap-2 mb-1">
                    <h3 className="text-white font-bold text-lg">ETA</h3>
              ...
              <div className="relative flex flex-col items-center group">
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl w-full hover:bg-white/10 transition-all hover:shadow-lg text-center">
                  ...
                  <h3 className="text-white font-bold text-lg mb-1">Sync Dados</h3>
